  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col gap-6 py-4 animate-fade-in">
      ...
      <div className="glass-panel-elevated rounded-3xl p-6 sm:p-8 relative overflow-hidden text-center specular-border">
        <div className="inline-flex p-3.5 rounded-2xl bg-gradient-to-b from-rose-500/25 via-purple-900/30 to-[#120520] border border-rose-500/40 text-rose-400 mb-3 shadow-xl shadow-rose-950/40 ring-1 ring-rose-400/20">
          <Sparkles className="w-6 h-6 text-rose-400" />
        </div>

        <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
          Комната <span className="text-rose-400 font-mono tracking-wider">#{roomId}</span>
        </h2>
        ...
        {/* Share Link Button */}
        <div className="mt-5 inline-flex items-center gap-2 p-1.5 bg-[#120520] rounded-2xl border border-white/[0.12] max-w-full shadow-inner">
          <span className="text-xs text-zinc-400 font-mono px-3.5 truncate max-w-[200px] sm:max-w-xs select-all">
            {window.location.origin}#room={roomId}
          </span>
          <button
            onClick={handleCopy}
            className="px-4 py-2 rounded-xl bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-400 hover:to-amber-400 text-slate-950 font-black text-xs flex items-center gap-1.5 transition-all shadow-md shadow-rose-950/50 border border-rose-300/40 cursor-pointer active:scale-95"
          >
      ...
      {!isJoined ? (
          ...
          <form onSubmit={handleJoin} className="flex flex-col gap-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 rounded-2xl bg-[#120520] text-white placeholder-zinc-600 border border-white/[0.1] focus:outline-none focus:border-rose-400 focus:ring-1 focus:ring-rose-400 text-base font-semibold transition-colors shadow-inner"
              />
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <button
                    ...
                    className="p-4 rounded-2xl border text-left bg-[#150624] border-amber-500/40 shadow-lg shadow-black/40 cursor-pointer group hover:border-amber-400/60 transition-all"
                  >
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl bg-gradient-to-r from-rose-500 via-orange-500 to-amber-400 hover:from-rose-400 hover:to-amber-300 text-slate-950 font-black text-base shadow-[0_0_30px_rgba(244,63,94,0.45)] border border-rose-300/50 transition-all disabled:opacity-40 cursor-pointer active:scale-[0.99]"
            >
              Войти в комнату
            </button>
          </form>
        ...
        <div className="glass-panel-elevated rounded-3xl p-6 sm:p-8 border border-amber-400/40 shadow-[0_0_40px_rgba(245,158,11,0.25)] specular-border relative overflow-hidden">
          <div className="flex items-center justify-between flex-wrap gap-2 mb-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-[#140624] hover:bg-[#200a38] text-amber-300 hover:text-amber-200 border border-amber-400/40 text-xs font-mono font-bold flex items-center gap-1.5 transition-all shadow-[0_0_12px_rgba(245,158,11,0.15)] cursor-pointer active:scale-95"
                  ...
                  <button
                    ...
                    className={`p-3 rounded-2xl border text-left flex items-center justify-between transition-all cursor-pointer active:scale-[0.98] ${
                      isSelected
                        ...
                        : 'bg-[#140624]/90 hover:bg-[#220a3a] border-white/[0.12] hover:border-amber-400/50 text-white shadow-inner'
                    }`}
                  >
                    <div>
          ...
          <form onSubmit={handleStart} className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 rounded-2xl bg-[#140624] text-amber-200 placeholder-zinc-700 border border-amber-400/40 focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-400/50 text-xl sm:text-2xl font-black tracking-widest uppercase font-mono text-center transition-all shadow-[0_0_20px_rgba(245,158,11,0.15)]"
              />
        ...
        <div className="glass-panel-elevated rounded-3xl p-6 sm:p-8 text-center specular-border">
          <div className="inline-flex p-4 rounded-2xl bg-[#160728] text-amber-400 border border-amber-400/30 mb-3 shadow-inner">
            <Gamepad2 className="w-8 h-8 animate-pulse text-amber-400" />
          </div>
              ...
              <div
                ...
                className={`p-3.5 rounded-2xl border flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all ${
                  isPlayerLeader
                    ...
                    : isMe
                    ? 'bg-[#160728]/90 border-white/[0.14]'
                    : 'bg-[#120520]/70 border-white/[0.08]'
                }`}
              >
                  ...
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center text-xs font-bold shrink-0 shadow-inner ${
                      isPlayerLeader
                        ...
                        : 'bg-[#1b0a30] text-zinc-300 border border-white/[0.08]'
                    }`}
                  >
                    {isPlayerLeader ? (
                      <Target className="w-4 h-4" />
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap self-end sm:self-center">
                    {!isPlayerLeader && onSetRoundLeader && (
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl bg-rose-950/40 hover:bg-rose-900/60 text-rose-200 border border-rose-700/40 text-xs font-semibold flex items-center gap-1 transition-all cursor-pointer shadow-sm"
