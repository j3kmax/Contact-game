      ...
      <div className="w-full max-w-xl glass-panel-glow rounded-3xl p-6 sm:p-8 shadow-2xl border border-indigo-500/30 relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-4 text-xs sm:text-sm text-slate-300 leading-relaxed">
          ...
          <div className="p-4 rounded-2xl bg-slate-900/70 border border-slate-800 flex gap-3">
            ...
            <div>
              <h4 className="font-bold text-white mb-1">3. «Есть контакт!» и таймер 10 секунд</h4>
              <p>
                Если другой игрок догадался, о чем речь, он жмет <strong>«КОНТАКТ!»</strong>. Запускается отсчет 10 секунд.
                В это время ведущий может отбить вопрос, введя слово (<em>«Это не Культиватор»</em>). Если ведущий успел — контакт сорван!
              </p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-900/70 border border-slate-800 flex gap-3">
            ...
            <div>
              <h4 className="font-bold text-white mb-1">4. Сверка слов</h4>
              <p>
                Если таймер истек, а ведущий не отбил, автор и партнер тайно вводят свои слова.
                Если слова <strong>совпали</strong> — ведущий обязан открыть следующую букву слова!
                Если слова не совпали — контакт провален, буква не открывается.
              </p>
            </div>
          </div>
